...
func (suite *ContentSuite) harvestSingleURLFromMockTweet(text string, urlText string) *HarvestedResource {
...
func (suite *ContentSuite) TestInvalidlyFormattedURLs() {
...
func (suite *ContentSuite) TestInvalidDestinationURLs() {
...
func (suite *ContentSuite) TestSimplifiedHostnames() {
...
func (suite *ContentSuite) TestIgnoreRules() {
...
func (suite *ContentSuite) TestResolvedURLRedirectedThroughHTMLProperly() {
...
func (suite *ContentSuite) TestResolvedURLCleaned() {
	hr := suite.harvestSingleURLFromMockTweet("Test a good URL %s which will redirect to a URL we want to ignore, with utm_* params", "http://bit.ly/lectio_harvester_resource_test01")
	isURLValid, isDestValid := hr.IsValid()
	suite.True(isURLValid, "URL should be formatted validly")
	suite.True(isDestValid, "URL should have valid destination")
...
func (suite *ContentSuite) TestResolvedDocumentURLNotCleaned() {
